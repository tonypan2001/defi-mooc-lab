...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    constructor() {
        ...
        debt_USDT = 8128956343; //8,128.956343
    ...
    function uniswapV2Call(
        ...
        console.log("WETH balance of address(this): %s", WETH.balanceOf(address(this)));
        ...
        // WBTC.transfer(address(uniswapV2Pair_WBTC_USDT), collateral_WBTC);
        // uint amountOut_USDT = getAmountOut(collateral_WBTC, reserve_WBTC_Pool3, reserve_USDT_Pool3);
        // uniswapV2Pair_WBTC_USDT.swap(0, amountOut_USDT, address(this), "");

        // 2.3 repay

        uint repay_WETH = getAmountIn(debtToCover, reserve_WETH_Pool4, reserve_USDC_Pool4);
        ...
        // uint getAmountOut_W = getAmountOut(balance_WBTC, reserve_WBTC_Pool2, reserve_WETH_Pool2);
        // uniswapV2Pair_WBTC_WETH.swap(0, getAmountOut_W, address(this), "");
